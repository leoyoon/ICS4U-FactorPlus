...
class MultipleChoiceViewController: UIViewController {
    ...
    func endGame() {
        ...
        performSegue(withIdentifier: "endMCF", sender: self) //proceed to the EndViewController
    ...
    @IBAction func pauseClicked(_ sender: AnyObject) {
        ...
        performSegue(withIdentifier: "pauseMCF", sender: sender)  //proceed to the PauseViewController
