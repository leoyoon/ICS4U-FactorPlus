...
class MainViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate {
   ...
   //declaration and initialization of the array of images that will be displayed in the collectionView  object
    ...
    override func viewDidLoad() {
        ...
        mainSlider.setThumbImage(thumbImage, for: UIControlState())
        mainSlider.setThumbImage(thumbImage, for: UIControlState.highlighted)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Options Cell", for: indexPath) as! OptionsCollectionViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        else if(segue.identifier == "Help")
        {
            ...
            let hvc = segue.destination as! HelpEntranceViewController
        }
        else if(segue.identifier == "Credits")
        {
            //Same concept as above
            let cvc = segue.destination as! CreditsViewController
        }
    }
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        let percentOffset = Float(scrollView.contentOffset.x)/520.0
