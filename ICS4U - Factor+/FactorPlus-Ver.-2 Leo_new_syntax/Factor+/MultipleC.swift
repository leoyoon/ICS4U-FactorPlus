...
class multipleChoice { //Start of multipleChoice class
    ...
    func getRAns(_ rI: Int) -> String { //An integer "rI" is randomly generated and sent from MCFViewController class
    ...
    func getSAns(_ sI: Int) -> String { //An integer "sI" is randomly generated and sent from MCFViewController class
    ...
    func getKAns(_ kI: Int) -> String { //An integer "kI" is randomly generated and sent from MCFViewController class
    ...
    func getJAns(_ jI: Int) -> String { //An integer "jI" is randomly generated and sent from MCFViewController class
