...
class UIFViewController: UIViewController {
    ...
    */
    ...
    func makeQuestion(){
        ...
        let quadraticRelation = quadratic(numCorrect: ttlScore)
    ...
    @IBAction func valChangeM(_ sender: AnyObject) {
        
        valChanged()
    }
    
    @IBAction func kClicked(_ sender: AnyObject) {
    ...
    @IBAction func jClicked(_ sender: AnyObject) {
    ...
    @IBAction func mClicked(_ sender: AnyObject) {
    ...
    @IBAction func nClicked(_ sender: AnyObject) {
    ...
    func endGame() {
        ...
        if(numQuestions == 10) {
            ...
            performSegue(withIdentifier: "endUIF", sender: self)
        }
    }
    ...
    @IBAction func pauseClicked(_ sender: AnyObject) {
        ...
        performSegue(withIdentifier: "pauseUIF", sender: sender)
    }
