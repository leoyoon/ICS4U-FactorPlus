...
class UIGViewController: UIViewController {
    ...
    */
    ...
    func makeNewGraph() {
        ...
        graphPoint.insert(GraphingPoints(), at: 0)
    }
    ...
    @IBAction func valChangeA(_ sender: AnyObject) {
    ...
    @IBAction func valChangeH(_ sender: AnyObject) {
    ...
    @IBAction func valChangeK(_ sender: AnyObject) {
    ...
    func setChart(_ xval: [String], yval: [Double]) { //this method plots the points on the LineChartViews
        ...
        for (i in 0 ..< 12) //the x-values and y-values are set to attributes xValues and yValues so that the coordinates can be transferred between PauseViewController and UIGViewController
        {
    ...
    @IBAction func pauseClicked(_ sender: AnyObject) {
        ...
        performSegue(withIdentifier: "pauseUIG", sender: sender)
    }
    ...
    func endGame() {
        ...
        if(numQuestions == 10) {
            ...
            performSegue(withIdentifier: "endUIG", sender: self)
        }
    }
    ...
    func checkAnswer() {
        ...
        let tempCorrectA = graphPoint[0].getaVal()
        let tempCorrectH = graphPoint[0].gethVal()
        let tempCorrectK = graphPoint[0].getkVal()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if(segue.identifier == "pauseUIG") {
            ...
            pvc.graphPoint.insert(graphPoint[0], at: 0)
        }
