...
class multipleCGraphComp { //Start of class
    ...
    func getaAns(_ aI: Int) -> String //Method accepts integer aI from MultipleCGraph class
    {
    ...
    func gethAns(_ hI: Int) -> String //Method accepts integer hI from MultipleCGraph class
    {
    ...
    func getkAns(_ kI: Int) -> String //Method accepts integer kI from MultipleCGraph class
    {
